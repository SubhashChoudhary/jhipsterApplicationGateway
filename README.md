...
To optimize the jhipsterApplicationGateway application for production, run:
...
[Service Discovery and Configuration with Consul]: http://www.jhipster.tech/documentation-archive/v4.14.5/microservices-architecture/#consul
