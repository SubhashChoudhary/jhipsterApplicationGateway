...
@EnableZuulProxy
public class JhipsterApplicationGatewayApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterApplicationGatewayApp.class);

    private final Environment env;

    public JhipsterApplicationGatewayApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterApplicationGateway.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterApplicationGatewayApp.class);
